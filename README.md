...
|---|---|
| [**Global Electronics Retail Sales Performance**](https://github.com/JoyceAbache/global-electronics-retail-sales-performance) | Excel dashboard analyzing $55.8M in multi-country retail sales — built formula-driven revenue/profit calculations from raw transaction data, then answered: which categories and markets drive revenue vs. margin, how does performance trend over time, and what's the online vs. in-store split. Includes written business insights alongside the visuals. |
| [**SQL Analysis**](https://github.com/JoyceAbache/maji-ndogo-water-analysis-SQL) | Cleaning and querying national water access data — the foundation for everything below |
| [**Part 1 — Visualization**](https://github.com/JoyceAbache/maji-ndogo-part1-powerbi-visualization) | First Power BI report: single-table analysis of water access and source types |
| [**Part 2 — Data Model**](https://github.com/JoyceAbache/maji-ndogo-part2-powerbi-datamodel) | Multi-table relational model connecting visits, wells, queues, and crime data |
